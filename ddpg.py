...
class ConstrainedDDPGPolicy(TD3Policy):
    def __init__(
        self,
        observation_space: spaces.Space,
        action_space: spaces.Box,
...
class ConstrainedDDPG(DDPG):
    """
    Contextual Bandit agent with safety projection and single critic.
    This implementation ignores bootstrapping and targets Q(s,a) ≈ r(s,a).
    """

    def __init__(
        self,
        policy: Union[str, Type[ConstrainedDDPGPolicy]],
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            # Contextual Bandit Target: Q(s,a) should match immediate reward
            ...
            q_actor_out = self.policy.critic(replay_data.observations, actor_actions)
